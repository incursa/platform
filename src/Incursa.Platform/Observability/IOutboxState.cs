...
{
    /// <summary>
    /// Gets a list of stuck outbox messages.
    /// </summary>
    ...
    Task<IReadOnlyList<(string MessageId, string Queue, DateTimeOffset CreatedAt)>> GetStuckMessagesAsync(TimeSpan threshold, CancellationToken cancellationToken);
}
