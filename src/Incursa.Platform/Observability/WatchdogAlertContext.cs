...
/// <param name="Component">The component that raised the alert (e.g., "scheduler", "inbox", "outbox", "processor").</param>
/// <param name="Key">A stable identity for the alert (e.g., jobId, messageId, queue name).</param>
...
public sealed record WatchdogAlertContext(
