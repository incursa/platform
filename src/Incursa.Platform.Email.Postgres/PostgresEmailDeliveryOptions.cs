...
/// </summary>
public sealed class PostgresEmailDeliveryOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the table name for email delivery events.
    /// Defaults to "EmailDeliveryEvents".
    /// </summary>
    public string TableName { get; set; } = "EmailDeliveryEvents";
