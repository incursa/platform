...
{
    /// <summary>
    /// Classifies the webhook envelope and determines the ingest decision.
    /// </summary>
    /// <param name="envelope">Webhook envelope.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Classification result.</returns>
    Task<ClassifyResult> ClassifyAsync(WebhookEnvelope envelope, CancellationToken cancellationToken);
}
