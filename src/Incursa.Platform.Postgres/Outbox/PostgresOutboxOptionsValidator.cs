...
internal sealed class PostgresOutboxOptionsValidator : IValidateOptions<PostgresOutboxOptions>
{
    public ValidateOptionsResult Validate(string? name, PostgresOutboxOptions options)
    {
