...
ALTER TABLE "$SchemaName$"."MetricPointHourly"
...
CREATE UNIQUE INDEX IF NOT EXISTS "UQ_MetricPointHourly_Key"
    ON "$SchemaName$"."MetricPointHourly" ("SeriesId", "BucketStartUtc", "BucketSecs");
...
ALTER TABLE "$SchemaName$"."ExporterHeartbeat"
    ADD COLUMN IF NOT EXISTS "InstanceId" varchar(100) NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS "LastFlushUtc" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ADD COLUMN IF NOT EXISTS "LastError" varchar(512) NULL;
