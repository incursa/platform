...
public class MultiOutboxDispatcherLeaseTests : PostgresTestBase
{
    private readonly FakeTimeProvider timeProvider = new();
    private readonly ConcurrentBag<string> processedMessages = new();

    public MultiOutboxDispatcherLeaseTests(ITestOutputHelper testOutputHelper, PostgresCollectionFixture fixture)
    ...
    public async Task MultiOutboxDispatcher_WithLease_PreventsConcurrentProcessing()
    {
        ...
        var outboxTable = PostgresSqlHelper.Qualify(schema, "Outbox");
