...
public sealed class InMemorySchedulerBehaviorTests : SchedulerBehaviorTestsBase
{
    public InMemorySchedulerBehaviorTests()
        : base(new InMemorySchedulerBehaviorHarness())
    {
    }
}
