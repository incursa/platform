...
internal sealed class InMemorySchedulerBehaviorHarness : ISchedulerBehaviorHarness
{
    private ServiceProvider? provider;
    private ISchedulerClient? schedulerClient;
    private ISchedulerStore? schedulerStore;
    private ISystemLeaseFactory? leaseFactory;
    ...
    public async Task ResetAsync()
    {
        ...
        schedulerClient = provider.GetRequiredService<ISchedulerClient>();
